...
import { View, Navigator, BackAndroid, Text, Image, TouchableHighlight } from 'react-native';
...
class _route {
    ...
    init(name, intent){
        ...
        if (_.isObject(name)){
            ...
            if (intent){
                return router(_firstNode, intent)
            }
            else {
                return this
            }
