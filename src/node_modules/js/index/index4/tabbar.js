...
let blogIcon = [
    ...
    <View>
        ...
        <Text style={{fontSize:11,marginBottom:2.1}}>博客</Text>
    </View>
]
...
let msgIcon = [
    ...
    <View>
        ...
        <Text style={{fontSize:11,marginBottom:2.1}}>消息</Text>
    </View>
]
...
let setIcon = [
    ...
    <View>
        ...
        <Text style={{fontSize:11,marginBottom:2.1}}>设置</Text>
    </View>
]
...
let bdgIcon = [
    ...
    <View>
        <Icon name="ios-settings" size={30} color="#4F8EF7" />
        <Text style={{fontSize:11,marginBottom:2.1}}>红点</Text>
    </View>
]
...
let rtIcon = [
    ...
    <View>
        <Icon name="ios-settings" size={30} color="#4F8EF7" />
        <Text style={{fontSize:11,marginBottom:2.1}}>路由</Text>
    </View>
]
